 ...
 * Pages
 *
 * Demo CMS pages and their sections.
 *
 * One runnable seed step. Run it on its own with
 * `npx tsx prisma/seed/pages.ts`, or tick it on the Seed files screen in the
 ...
 */
import { prisma, seedPages } from '../seed';
import { runSeedStep } from './_shared';

runSeedStep('pages', seedPages, prisma);

 ...
 * Countries
 *
 * The markets the platform ships with (India, UAE).
 *
 * One runnable seed step. Run it on its own with
 * `npx tsx prisma/seed/countries.ts`, or tick it on the Seed files screen in the
 ...
 */
import { prisma, seedCountries } from '../seed';
import { runSeedStep } from './_shared';

runSeedStep('countries', seedCountries, prisma);

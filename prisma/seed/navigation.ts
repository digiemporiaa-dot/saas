 ...
 * Navigation
 *
 * Header, footer and legal menus.
 *
 * One runnable seed step. Run it on its own with
 * `npx tsx prisma/seed/navigation.ts`, or tick it on the Seed files screen in the
 ...
 */
import { prisma, seedNavigation } from '../seed';
import { runSeedStep } from './_shared';

runSeedStep('navigation', seedNavigation, prisma);

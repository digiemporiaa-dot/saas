 ...
 * Settings
 *
 * Website, SEO, tracking, email and per-market settings.
 *
 * One runnable seed step. Run it on its own with
 * `npx tsx prisma/seed/settings.ts`, or tick it on the Seed files screen in the
 ...
 */
import { prisma, seedSettings } from '../seed';
import { runSeedStep } from './_shared';

runSeedStep('settings', seedSettings, prisma);

...
function readProductForm(formData: FormData) {
  return productInputSchema.parse({
    ...
    storageLabel: formData.get('storageLabel'),
    usersLabel: formData.get('usersLabel'),
...
function toPrismaData(input: ReturnType<typeof readProductForm>) {
  return {
    ...
    storageLabel: input.storageLabel ? sanitizeText(input.storageLabel) : null,
    usersLabel: input.usersLabel ? sanitizeText(input.usersLabel) : null,

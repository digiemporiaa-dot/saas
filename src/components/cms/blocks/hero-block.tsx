...
import { SectionHeading, CtaLink, mainCtaVariant, CmsImage, type BlockContext } from './shared';
...
export async function HeroBlock({ content, ctx }: { content: HeroContent; ctx: BlockContext }) {
  ...
  const formPanel = showForm ? (
    <FormPanel
      ...
      card="rounded-[var(--layout-card-radius)] border border-hairline bg-surface p-6 shadow-xl sm:p-7"
